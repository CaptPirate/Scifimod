...
public class TileEntityHarvestor extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.harvestor";
	}
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = HarvestorRecipes.getInstance().getHarvestorResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = HarvestorRecipes.getInstance().getHarvestorResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
